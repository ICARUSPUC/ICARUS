...
public class MachineEnemyFast : MonoBehaviour
{
    ...
    public float fireRate = 0.15f; // <--- AUMENTADO A CAD�NCIA: Tempo entre tiros menor (0.15s)
    ...
    void Update()
    {
        // O tiro � acionado continuamente (sem depender da anima��o)
    ...
    void Disparar()
    {
        ...
        // O tiro ainda usa o mesmo prefab, mas a velocidade � controlada pelo script da bala (abaixo).
