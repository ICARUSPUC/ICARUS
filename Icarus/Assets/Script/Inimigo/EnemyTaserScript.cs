...
public class MachineEnemyTaser : MonoBehaviour
{
    ...
    // Alterado para um array de Transform para os m�ltiplos pontos de disparo
    public Transform[] firePoints;
    public float fireRate = 0.5f; // Cad�ncia de tiro diminu�da (tempo entre tiros aumentado)
    ...
    void Update()
    {
        // *** L�GICA DE DISPARO REVISADA ***
        // O tiro � agora ACIONADO CONTINUAMENTE, independentemente da anima��o.
        ...
        // As linhas abaixo foram removidas/ignoradas para garantir o tiro cont�nuo:
    ...
    void Disparar()
    {
        ...
        // Avan�a para o pr�ximo ponto de disparo no array (circularmente)
